...
def create_default_admin():
    ...
    if not User.query.filter_by(role='admin').first():
        ...
        admin = User(name='Administrator', email=email, phone=os.environ.get('ADMIN_PHONE', ''), password=generate_password_hash(os.environ.get('ADMIN_PASSWORD', 'change-me')), role='admin', is_approved=True)
